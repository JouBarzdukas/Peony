        ...
        >
          ...
          <CardContent>
            ...
            >
                ...
                <Bar
                  dataKey="steps"
                  fill="#4B0082" // Using a CSS variable for color
                  radius={5}
                  fillOpacity={0.6}
              ...
              >
                ...
                <XAxis
                  ...
                  <Line
                    dataKey="resting"
                    type="natural"
                    fill="#4B0082" // Dark purple color
                    stroke="#4B0082" // Dark purple color
                    strokeWidth={2}
                    dot={false}
                    activeDot={{
                    fill: "#4B0082", // Dark purple color
            ...
            <div className="grid auto-rows-min gap-2">
              ...
              >
                ...
                >
                    <Bar
                      dataKey="steps"
                      fill="#9370DB" // Medium purple color
                      radius={4}
                      barSize={32}
                    >
                      <LabelList
          ...
          <CardContent className="flex gap-4 p-4 pb-2">
            ...
            >
                ...
                data={[
                  ...
                  value: (8 / 12) * 100,
                  label: "8/12 hr",
                  fill: "#9370DB", // Medium creme purple
                    },
                    {
                    activity: "exercise",
                    value: (46 / 60) * 100,
                    label: "46/60 min",
                    fill: "#779ECB", // Darker pastel blue
                    },
                    {
                    activity: "move",
                    value: (245 / 360) * 100,
                    label: "245/360 kcal",
                    fill: "#77DD77", // Darker pastel green
                    },
                  ]}
                  layout="vertical"
                  barSize={32}
